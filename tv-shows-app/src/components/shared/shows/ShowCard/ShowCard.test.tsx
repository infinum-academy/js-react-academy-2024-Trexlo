...
describe('ShowCard', () => {
    const mockShow:IShow = {title: 'test', average_rating:1, description:"desc", id:"1", image_url:"url", no_of_reviews:1};
    const mockShowNoRating:IShow = {title: 'test', average_rating:undefined, description:"desc", id:"1", image_url:"url", no_of_reviews:1};
